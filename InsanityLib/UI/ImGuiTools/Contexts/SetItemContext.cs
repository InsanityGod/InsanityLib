...
{
    public class SetItemContext : ImGuiContext
    {
        ...
        public SetItemContext(object targetObject, MemberInfo member, Type valueType, object currentValue, ImGuiContext parentContext, string id = null, string name = null, IServiceProvider serviceProvider = null) : base(targetObject, member, parentContext, id, name, serviceProvider)
        {
            ValueType = valueType;
