...
//namespace InsanityLib.Auto.Command; //TODO

//[AttributeUsage(AttributeTargets.Parameter)]
//public class CommandParameterAttribute : Attribute
//{
//    public EContextualSource Source { get; set; }
...
//        {
//            if(Source == EContextualSource.Specify) return new CollectibleArgParser(argName, provider.GetService<ICoreAPI>(), EnumItemClass.Block, true); 
//        }
//        else if(typeof(Item).IsAssignableFrom(paramType))
//        {
//            if(Source == EContextualSource.Specify) return new CollectibleArgParser(argName, provider.GetService<ICoreAPI>(), EnumItemClass.Item, true);
//        }
...
//        {
//             if(Source == EContextualSource.Specify) return new WorldPositionArgParser(argName, provider.GetService<ICoreAPI>(), true);
//        }
